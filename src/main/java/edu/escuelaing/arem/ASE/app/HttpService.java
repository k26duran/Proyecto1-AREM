...
public class HttpService {
	...
	/**
	 * M�todo que inicializa el atributo listaURLHandler que tendr� todos los m�todos con anotaciones del package app
	 */
	public void init(){
		try {
	...
	public static Socket receiveRequest(ServerSocket serverSocket) {
	 ...
	 /**
     * En este m�todo se identifica que tipo de solicitud se realiz� al servidor
     * @param address corresponde a la direcci�n del recurso que se desea obtener
    ...
    /**
     * Este m�todo publica una p�gina html que ha sido solicitada en el servidor,
    ...
    /**
     * Este m�todo publica un recurso dentro de la listaURLHandler en el servidor
    ...
    /**
     * Este m�todo publica una imagen con extension PNG en el servidor,
    ...
    /**
     * Se publica un p�gina con un mensaje de error, esto se hace cuando un recurso no existe
     */
    ...
    /**
     * Este m�todo cierra el archivo con el cual el servidor realiza su lectura
	...
	/**
	 * Este m�todo lee un archivo html para luego poder publicarlo en el servidor
    ...
    /**
     * Este m�todo lee una imagen .PNG y la convierte en Bytes para poder visualizarla 
    ...
    /**
     * Este m�todo busca en todas las clases del package /app los m�todos que contengan la anotaci�n '@Web'
     * y los ubica en un hashMap
     * @param direccion corresponde a la direcci�n del recurso que se desea obtener y que se encuentra ubicado en el package app
     */
